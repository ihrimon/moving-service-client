...
const Register = () => {
    ...
    return (
        <div className='container'>
            <div className="w-50 form-style custom-shadow mx-auto my-5 border-radius custom-shadow">
                ...
                <form onSubmit={handleRegistrationSubmit} className="w-75 mx-auto mt-3">
                    ...
                    <button type="submit" className="btn bg-color-sm px-5 text-light my-3">Register</button>
